...
@section('content')
    <div>
        <a href="{{ route('products.index') }}" class="text-blue-600 hover:text-blue-500 transition duration-200">
    ...
    <div class="container mx-auto p-4">
        ...
        @if ($product->image_path)
            <div class="flex justify-center">
                <img src="{{ asset('storage/'.$product->image_path) }}" alt="{{ $product->title }}" class="mb-4 w-1/3 rounded-lg">
            </div>
        @endif
