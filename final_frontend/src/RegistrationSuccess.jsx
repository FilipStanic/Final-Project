...
const RegistrationSuccess = () => {
    ...
    return (
        <div className="flex justify-center items-center min-h-screen">
            <div className="w-full max-w-md p-8 space-y-6 bg-[#093a74] rounded-lg shadow-md text-center">
                <h2 className="text-2xl font-bold text-green-500">Registration Successful!</h2>
                <p className="text-white">We've sent a verification link to your email. Please check your inbox and verify your account before logging in.</p>
                <button
